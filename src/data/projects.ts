...
export const projectsData: ProjectItem[] = [
  {
    ...
    technologies: ["PHP 8.3", "Symfony 7", "API Platform", "MySQL", "REST API", "JWT", "Doctrine ORM", "Docker"],
    focusAreas: [
      "API Architecture",
    ...
    githubUrl: "https://github.com/amal-regaieg",
  ...
  },
  {
    ...
    technologies: ["PHP 8.3", "Symfony 7", "MySQL", "REST API", "API Platform", "Doctrine ORM", "Redis Cache", "SQL Optimization"],
    focusAreas: [
  ...
  },
  {
    ...
    technologies: ["PHP 8.3", "Symfony 7", "Stripe API", "REST API", "Webhooks", "Symfony Messenger", "MySQL", "Doctrine Transactions"],
    focusAreas: [
      "Payment Processing",
